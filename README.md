...
Welcome to my project portfolio! Below is a collection of projects I’ve worked on, showcasing my expertise in AI, machine learning, and autonomous systems. These projects range from **object detection** and **3D reconstruction** to **semantic segmentation** and **CI/CD** pipeline implementations. Explore the repositories and get a glimpse of my skills in action.
...
### 2. **3D Object Detection (Traditional Methods)**
...
### 3. **Object Detection and Tracking using Kalman Filters**
...
### 4. **Stereo Vision and 3D Reconstruction**
...
### 5. **Multi-Object Tracking with YOLOv3**
...
### 6. **Semantic Segmentation for Drivable Area Detection**
...
### 7. **Object Detection with ROS Package**
...
### 8. **3D Deep Learning with PointNet Architecture**
...
### 9. **Battery Parameter Prediction Using DNN**
- **Description**: **Deep Neural Networks (DNN)** for battery parameter prediction in energy applications.
...
### 10. **Advanced C++ Practice for Autonomous Systems**
...
### 11. **YouTube Channel on Autonomous Driving**
...
### 12. **Dice Roller App (Android Studio)**
- **Description**: A **Kotlin** and **Jetpack Compose** based Dice Roller app for Android.
- **GitHub Repo**: [Dice Roller App](https://github.com/Mayakshanesht/Dice_Roller_Android)

### 13. **CNN-Based Classification & GAN Projects**
...
### 14. **PELR Transformer for BEV Semantic Grip Mapping**
...
In addition to these projects, I have published several **research papers** and actively contribute to projects involving **autonomous vehicles**, **robotics**, and **AI/ML**. My aim is to create robust, scalable solutions and build next-gen technologies.

Feel free to explore the repositories and reach out for any collaboration or discussions!
