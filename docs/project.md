...
- **Description:** A deep learning approach to detect drivable areas using **semantic segmentation**.
...
- **Description:** Deep Neural Networks (DNN) for predicting battery parameters in energy applications.
...
- **Description:** A Dice Roller app built using **Kotlin** and **Jetpack Compose** for Android.
- **GitHub Repo:** [Dice Roller App](https://github.com/Mayakshanesht/Dice_Roller_Android)

### 12. CNN-Based Classification & GAN Projects
- **Description:** Various projects involving **CNN** for object and face detection along with **GAN** applications.
